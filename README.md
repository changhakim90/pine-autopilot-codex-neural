...
v10 can use your M4 Pro GPU locally, without pretending that a synthetic game simulator is real. It trains only on recorded Pine transitions, including manual demonstrations, then lets the live game run a blind tournament before accepting the result.
